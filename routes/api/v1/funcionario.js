...
// ADM
router.get('/adm', auth.required, ZonaValidation.adm, funcionarioController.indexAdm);
router.get('/adm/:id', auth.required, ZonaValidation.adm, funcionarioController.showAdm);
router.get("/adm/search/:search", auth.required, ZonaValidation.adm, funcionarioController.searchAlunos);
